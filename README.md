...
* Slovenian data consistently performs worse. This might be due to the low quality of the input data, I encountered weird, Hojsian punctuation style (e.g. misplaced .periods ,and commas [sic]). Additional preprocessing should no doubt improve classification accuracy, but since this was not the purpose of this exercise, it was not performed.
